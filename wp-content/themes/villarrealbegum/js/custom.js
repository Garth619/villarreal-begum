...
*/
 ...
 $slidertwo.slick({
  ...
  var sectwoslidecount = $('.sec_two_slider .slick-slide:not(.slick-cloned)').length;
  
  var finalslidecounttwo = ('0' + sectwoslidecount).slice(-2);
  
  $('.sec_two_last_slide_number').text(finalslidecounttwo);
